// User-provided code for AdminOrderPage.jsx starts here...
                ...
                <div className="bg-white rounded-lg max-w-2xl w-full mx-4 max-h-[90vh] overflow-y-auto">
                  <div className="p-6">
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        <h3 className="font-medium mb-2 flex items-center gap-2"><User className="h-4 w-4" />用户信息</h3>
                      ...
                      {selectedOrder.shipping_address && (
                        <div>
                          <h3 className="font-medium mb-2 flex items-center gap-2"><MapPin className="h-4 w-4" />收货地址</h3>
                          <div className="bg-gray-50 p-3 rounded">
    ...
    // ... User-provided code for AdminOrderPage.jsx ends here
